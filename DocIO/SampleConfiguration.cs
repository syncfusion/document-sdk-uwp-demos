...
namespace Syncfusion.SampleBrowser.UWP.DocIO
{
    ...
    public class SamplesConfiguration
    {
        ...
        public SamplesConfiguration()
        {
            ...
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                SampleView = typeof(EssentialDocIO.WordToHTML).AssemblyQualifiedName,
                Header = "Word to HTML",
                Category = Categories.FileFormat,
                SampleCategory = "Import and Export",
                Product = "DocIO",
                Description = "This sample demonstrates how to convert a Word document to HTML using .NET Word Library (DocIO).",
                Tag = Tags.None,
                SearchKeys = new string[] { "WordToHTML", "Word", "HTML" }
            });
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                SampleView = typeof(EssentialDocIO.HTMLToWord).AssemblyQualifiedName,
                Header = "HTML to Word",
                Category = Categories.FileFormat,
                SampleCategory = "Import and Export",
                Product = "DocIO",
                Description = "This sample demonstrates how to convert the HTML to a Word document using .NET Word Library (DocIO).",
                Tag = Tags.None,
                SearchKeys = new string[] { "HTMLToWord", "Word", "HTML" }
            });
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
            ...
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                SampleView = typeof(EssentialDocIO.CreateSmartArtDemo).AssemblyQualifiedName,
                Header = "Create SmartArt",
                Category = Categories.FileFormat,
                SampleCategory = "SmartArts",
                Product = "DocIO",
                ...
                Tag = Tags.None,
                SearchKeys = new string[] { "Create SmartArt", "SmartArt" }
            });
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
                SampleView = typeof(EssentialDocIO.EditSmartArtDemo).AssemblyQualifiedName,
                Header = "Edit SmartArt",
                Category = Categories.FileFormat,
                SampleCategory = "SmartArts",
                Product = "DocIO",
                Description = "This sample demonstrates how to modify SmartArt graphics in a Word document using the .NET Word Library (DocIO).",
                Tag = Tags.None,
                SearchKeys = new string[] { "SmartArt", "Edit SmartArt" }
            });
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
			 ...
			 SampleHelper.SampleViews.Add(new SampleInfo()
            {
                SampleView = typeof(EssentialDocIO.DocumentProtectionDemo).AssemblyQualifiedName,
                Header = "Document Protection",
                Category = Categories.FileFormat,
                SampleCategory = "Security",
                Product = "DocIO",
                SearchKeys = new string[] { "Security", "DocumentProtection" },
                Tag = Tags.None
            });
            SampleHelper.SampleViews.Add(new SampleInfo()
            {
